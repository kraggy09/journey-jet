  ...
  return (
    <div className="w-[90%] relative">
      ...
      <div className="lg:w-[40%] xl:pt-36 md:w-[60%] md:mx-6 lg:mx-16 ">
        ...
        <p className="mt-2 lg:pb-6 lg:text-start lg:mt-6 text-center text-gray-500 mx-8 md:mx-0 ">
          Thrown shy denote ten ladies though ask saw. Or by to he going think
          order event music. Incommode so intention defective at convinced. Led
          income months itself and houses you.
        </p>
        <div className="flex md:flex-row justify-around mt-6 flex-col ">
          <button className="mx-auto my-3 hover:cursor:pointer md:mx-0 md:my-0">
            <svg
